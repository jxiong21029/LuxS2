...
class UNet(nn.Module):
    def __init__(self, n_channels=41, bilinear=False):
        ...
        self.types_linear = nn.Linear(32, 13)
        self.resources_linear = nn.Linear(32, 5)
        self.quantities_linear = nn.Linear(32, 1)
    ...
    def forward(self, x):
        ...
        output = logits.transpose(1, 3).transpose(1, 2)
        # print(output.size())
