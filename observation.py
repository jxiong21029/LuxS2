...
# TODO: observations should include the units' action queues (in this case,
#  simply the last action taken).
def get_obs(state: JuxState):
    # for now: heuristic behavior for bidding, factory placement + actions
    ...
    for team in range(2):
        ...
        # factory: occupancy, [center, cargo: ice, ore, water, metal; lichen]
        # separate obs for ally and enemy
